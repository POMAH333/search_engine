...
* Плагин VSCode для тестирования: Google Test Adapter
...
Скомпилированный файл располагается в папке search_engine\out\build\search_engine\src и называется search_engine.exe
